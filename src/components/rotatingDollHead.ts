export function createDollHead():void{
    const dollHead = new Entity();
    engine.addEntity(dollHead);

    dollHead.addComponent(new GLTFShape("models/RedLightGreenLight_Asset_DollHead.glb"));
    dollHead.addComponent(new Transform({ 
